...
import com.threesister.DAO.UserLogin;
...
public class LoginForm extends javax.swing.JFrame {
    ...
    public LoginForm() {
        ...
        this.setLocationRelativeTo(null); //appears form center of the screen
    }
    ...
    private void initComponents() {
        ...
        usernameTxt.setBackground(java.awt.Color.white);
        ...
        passwordTxt.setBackground(java.awt.Color.white);
        passwordTxt.setText("jPasswordField1");

        loginBtn.setBackground(new java.awt.Color(34, 49, 63));
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        if ((!"".equals(username) || username != null) && (!"".equals(password) || password != null)) {
            boolean isValid = UserLogin.checkLogin(username, password);
            if (isValid) {
            ...
            JOptionPane.showMessageDialog(null, "Please provide credentials", "Login failed", JOptionPane.ERROR_MESSAGE);
